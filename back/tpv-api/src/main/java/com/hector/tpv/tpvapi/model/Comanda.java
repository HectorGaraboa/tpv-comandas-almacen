...
public class Comanda {
    ...
    public enum Estado {
        ABIERTA, ENVIADA, ANULADA, COBRADA, CERRADA
    }
    ...
    public LocalDateTime getCreadaAt() {
        return creadaAt;
    }

    public void setCreadaAt(LocalDateTime creadaAt) {
    ...
    public LocalDateTime getCobradaAt() {
        return cobradaAt;
    }

    public void setCobradaAt(LocalDateTime cobradaAt) {
        this.cobradaAt = cobradaAt;
    }

    public LocalDateTime getCerradaAt() {
        return cerradaAt;
    }

    public void setCerradaAt(LocalDateTime cerradaAt) {
        this.cerradaAt = cerradaAt;
    }
}
